...
Game.Level1.prototype = {
    ...
    create:function(game){
        /*this.stage.backgroundColor = '#0000f7';*/
        game.add.sprite(0,10,'fond');
        game.add.sprite(1200,10,'fond2');
        game.add.sprite(2200,10,'fond3');

        music = game.add.audio('song');
        music.play();

        //Espace time - gestion de la gravité
        this.physics.arcade.gravity.y = 800;//1400;
        ...
        player.body.collideWorddBounds = true;

        controls = {
            right:  this.input.keyboard.addKey(Phaser.Keyboard.RIGHT),
            left:   this.input.keyboard.addKey(Phaser.Keyboard.LEFT),
            up:     this.input.keyboard.addKey(Phaser.Keyboard.UP),
            shoot:  this.input.keyboard.addKey(Phaser.Keyboard.A),
        };
